    ...
    all: [
      {
        ...
        description: 'For optimum freshness, coffee should be stored within the relative humidity range of 50% to 65% and within the temperature range of 33F to 68F (0.6C to 20C)'
      },
      {
        type: 'Art',
